...
type
  ...
  private
    procedure do_Text(ACustomHeader:TCustomHeader; AData:pointer; ASize:integer);
    procedure do_Voice(ACustomHeader:TCustomHeader; AData:pointer; ASize:integer);
    procedure do_Video(ACustomHeader:TCustomHeader; AData:pointer; ASize:integer);
  public
    constructor Create;
...
procedure TClientSocket.do_Text(ACustomHeader: TCustomHeader; AData: pointer;
  ASize: integer);
var
  sMsg : string;
begin
...
procedure TClientSocket.do_Video(ACustomHeader: TCustomHeader; AData: pointer;
  ASize: integer);
begin
  TVideoOut.Obj.DataIn( AData, ASize );
end;

procedure TClientSocket.do_Voice(ACustomHeader: TCustomHeader; AData: pointer;
  ASize: integer);
begin
  TVoiceOut.Obj.DataIn( AData, ASize );
end;
